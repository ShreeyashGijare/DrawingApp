...
class MainActivity : AppCompatActivity() {
    ...
    val requestPermission: ActivityResultLauncher<Array<String>> =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
            ...
            permissions.entries.forEach{
                ...
                if(isGranted){
                    Toast.makeText(this, "Permission granted for reading files", Toast.LENGTH_LONG).show()
    ...
    private fun showBrushSizeChooserDialog(){
        ...
        val extrasmallBtn: ImageButton = brushDialog.findViewById(R.id.ibExtraSmallBrush)
    ...
    private fun showProgressDialog() {
        ...
        customProgressDialog?.setContentView(R.layout.dialogcustompprogress)
